"""
run_baseline_rmsc04.py  —  ABIDES daily-investor baseline runner (RMSC04 calibration)
=====================================================================================

This is a duplicate of `test.py` with the market-background parameters swapped from
AAPL calibration to the RMSC04 configuration used by the market simulation.
...
def parse_args():
    ...
    p.add_argument("--out_dir",       type=str,   default="plots_rmsc04")
    p.add_argument("--results_file",  type=str,   default="baseline_results_rmsc04.json")
...
def main():
    ...
    print("=" * 62)
    print("ABIDES  ·  markets-daily_investor-v0  ·  RMSC04 calibration")
    print("=" * 62)
